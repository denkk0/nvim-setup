...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/copilot.vim",
    url = "https://github.com/github/copilot.vim"
  },
  ["dracula.nvim"] = {
    config = { "\27LJ\2\n7\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0\24colorscheme dracula\bcmd\bvim\0" },
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["markdown-preview.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/opt/markdown-preview.nvim",
  ...
  ["neoscroll.nvim"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/neoscroll.nvim",
  ...
  ["nvim-comment"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  ["nvim-notify"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/nvim-notify",
  ...
  ["rust.vim"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/rust.vim",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
  ...
  ["vim-python-pep8-indent"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/vim-python-pep8-indent",
    url = "https://github.com/Vimjas/vim-python-pep8-indent"
  },
  ["vim-startuptime"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/vim-startuptime",
    url = "https://github.com/dstein64/vim-startuptime"
  },
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/Users/denis/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
